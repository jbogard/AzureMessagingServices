...
await Deployment.RunAsync(async () =>
{
    ...
    var eventHubResources = new EventHubResources(prefix, resourceGroup, jimmyUser);
    ...
    return new Dictionary<string, object?>
    {
        ...
        { "EventHubNamespaceName", eventHubResources.EventHubNamespaceName },
        { "EventHubName", eventHubResources.EventHubName },
    };
});